    ...
    <div className="grid w-full max-w-sm items-center gap-1.5">
      ...
      <DropdownMenu >
        <DropdownMenuTrigger asChild>
          <button className={cn("h-8 p-2 rounded-md sm:h-10 md:h-12 lg:h-14 sm:w-64 md:w-72 lg:w-80 sm:rounded-lg lg:rounded-xl text-left text-sm transition-all focus:ring-1 focus:ring-ring border border-gray-300 focus:outline-none",  isPlaceholder ? "text-muted-foreground placeholder:text-muted-foreground" : "text-foreground", dropDownClassName)}>
