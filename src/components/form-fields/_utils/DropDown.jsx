    ...
    <div className="grid w-full max-w-sm items-center gap-1.5">
      ...
      <DropdownMenu >
        <DropdownMenuTrigger asChild>
          <button className={cn("rounded-md sm:rounded-lg lg:rounded-xl text-left text-sm transition-all focus:ring-1 focus:ring-ring border bg-ternary border-gray-300 focus:outline-none",  isPlaceholder ? "text-muted-foreground placeholder:text-muted-foreground" : "text-foreground", dropDownClassName)}>
